...
public class VehicleCrudView {
    ...
    public VehicleCrudView(MainMenuView mainMenuView) {
...
//            cbCustomer.getItems().setAll(mainMenuController.getAllCustomers());
    ...
    private void onConfigureOwners() {
        ...
        List<Customer> allCustomers = mainMenuView.getAllCustomers();
    ...
    private void registerNewCustomerAndRefresh(ObservableList<Customer> available, TableView<Customer> table) {
        ...
        OperationResult result = mainMenuView.createCustomer(c);
        ...
        List<Customer> refreshed = mainMenuView.getAllCustomers();
    ...
    private void fillCbox() {
        ...
        cbVehicleType.getItems().setAll(mainMenuView.getAllVehicleTypes());
    }

    private void loadData() {
        masterList.setAll(mainMenuView.getAllVehicles());
        updateRecordCount();
    }
    ...
    private void onCreate(ActionEvent actionEvent) {
        ...
        Rate rate = mainMenuView.getRateController().findBySpaceType(vehicleSpaceType.getSpaceType());
        ...
        CrudAlertHelper.showResult(
                "Vehículo",
                mainMenuView.createVehicle(vehicle)
        );
        loadData();
    }
    ...
    private void onUpdate(ActionEvent actionEvent) {
        ...
        Vehicle vehicle = mainMenuView.readVehicleByPlate(plate);
        vehicle.setPlate(plate);
        vehicle.setVehicleStatus(VehicleStatus.EXITED);
...
//        Customer owner = mainMenuController.getCustomerController().findCustomerById(Integer.parseInt(tfCustomerId.getText().trim()));
        ...
        vehicle.setTicket(null);
        vehicle.setOwners(new ArrayList<>(selectedOwners));
        CrudAlertHelper.showResult("Vehiculos", mainMenuView.updateVehicle(vehicle));
        loadData();
    }
    ...
    private void onDelete(ActionEvent actionEvent) {
        ...
        CrudAlertHelper.showResult("Vehiculos", mainMenuView.deleteVehicle(vehicle));
        loadData();
    }
