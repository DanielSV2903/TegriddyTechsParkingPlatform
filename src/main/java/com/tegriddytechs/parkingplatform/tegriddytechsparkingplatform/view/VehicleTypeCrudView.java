...
public class VehicleTypeCrudView {
    ...
    public VehicleTypeCrudView(MainMenuView mainMenuView) {
    ...
    private void onCreate() {
        ...
        try {
            OperationResult result = mainMenuView.getVehicleTypeController().addVehicleType(vt);
    ...
    private void onUpdate() {
        ...
        try {
            OperationResult result = mainMenuView.getVehicleTypeController().updateVehicleType(vt);
            CrudAlertHelper.showResult("Tipos de Vehículo", result);
            onClear();
            loadData();
        } catch (IOException e) {
    ...
    private void onDelete() {
        ...
        VehicleType existing = mainMenuView.getVehicleTypeController().findById(id);
        if (existing == null) {
        ...
        try {
            OperationResult result = mainMenuView.getVehicleTypeController().removeVehicleType(existing);
            CrudAlertHelper.showResult("Tipos de Vehículo", result);
            onClear();
            loadData();
        } catch (IOException e) {
