...
public class ParkingSpaceConfigDialogView {
    @FXML
    private Spinner<Integer> spTotalSpaces;
    @FXML
    private Spinner<Integer> spPreferentialPercent;
    @FXML
    private Label lblPreferentialCount;
    @FXML
    private Label lblSumByType;
    @FXML
    private Label lblRemaining;
    @FXML
    private Label lblValidation;
    @FXML
    private TableView<TypeRow> tblTypes;
    @FXML
    private TableColumn<TypeRow, String> colTypeName;
    @FXML
    private TableColumn<TypeRow, Integer> colCount;
    @FXML
