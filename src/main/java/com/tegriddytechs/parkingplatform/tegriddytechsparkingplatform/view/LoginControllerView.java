    ...
    private void loadMenu(ActionEvent event, UserRole role) {
        try {
            ...
            if (role == UserRole.ADMIN){
                ...
                loader = new FXMLLoader(
                        TegriddyTechsParkingPlatformApp.class.getResource(
                                "/tegriddytechsparkingplatform/clerk-menu-view.fxml"
                        )
                );
            }
            ...
            if (controller instanceof MainMenuView mainMenuView) {
                mainMenuView.setUser(actualUser);
            }
